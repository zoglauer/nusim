...
pos_a_0_file = path+'20110126_H81_xrg_cal.sav'
pos_a_1_file = path+'20110128_H80_xrg_cal.sav'
pos_a_2_file = path+'20110203_H82_xrg_cal.sav'
pos_a_3_file = path+'20110202_H75_xrg_cal.sav'
...
;         print,thisx, thisy;, total(invert_data[thisx, thisy].pdf)
   ...
   lasttime = thistime
   save, invert_data, file = 'invert_new_fpmb.sav'
