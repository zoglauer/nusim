...
pro nuskybgd_spec,indir,obsid,srcreg,specdir,bgddir,ab,bgddirref, $
      paramfile=paramfile,specname=specname,expfactor=expfactor,$
...
readcol,paramfile,p0,p1,p2,p3,/silent
...
printf,lun,'model nuabs*(po*highecut+po)'
...
spawn,'fparkey '+cldir+specdir+'/bgd'+fakname+' '+specname+' BACKFILE'
print,'fparkey '+cldir+specdir+'/bgd'+fakname+' '+specname+' BACKFILE'
line=''
