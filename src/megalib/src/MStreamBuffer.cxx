...
void MStreamBuffer::SetRejection(TString Rejection)
{
  bool Found = false;
...
bool MStreamBuffer::Connect(TString FileName, bool Append, bool TimePrefix)
{
...
bool MStreamBuffer::Disconnect(TString FileName)
{
  if (m_Enabled == false) return false;
