...
MGUIProgressBar::MGUIProgressBar(): MGUIDialog(gClient->GetRoot(), gClient->GetRoot(), 300, 200)
{
  ...
  m_Title = TString("Status");
  m_SubTitle = TString("Progress");
...
MGUIProgressBar::MGUIProgressBar(const TGWindow* ParentWindow, const char* Title, 
                                 const char* SubTitle): 
  MGUIDialog(gClient->GetRoot(), gClient->GetRoot(), 350, 200)
{
  //
  ...
  m_Title = TString(Title);
  m_SubTitle = TString(SubTitle);
