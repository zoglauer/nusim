...
MGUIECBList::MGUIECBList(const TGWindow *Parent, TString Label, bool IsMultiple) :
...
TString MGUIECBList::GetName(int i)
{
  // Return the label name at position i

  if (i >= 0 && i < m_CBList->GetLast()+1) {
    return ((TObjString*) m_NamesList->At(i))->GetString();
  }
...
void MGUIECBList::Add(TString CBLabel, bool Selected)
{
