...
MResponseMatrixO2::MResponseMatrixO2(TString Name, vector<float> xAxis, 
                                     vector<float> yAxis) 
...
void MResponseMatrixO2::SetAxisNames(TString x1Name, TString x2Name)
{
...
TString MResponseMatrixO2::GetAxisName(unsigned int order) const
{
...
bool MResponseMatrixO2::Write(TString FileName, bool Stream)
{
