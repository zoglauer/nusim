...
MGUIEFileSelector::MGUIEFileSelector(const TGWindow* Parent, TString Label, 
                                     TString FileName) :
...
void MGUIEFileSelector::Create()
{
  ...
  // input label:
  TString Icon = g_MEGAlibPath + "/resource/icons/folder.xpm";
  gSystem->ExpandPathName(Icon);
  gSystem->ExpandPathName(Icon);
...
TString MGUIEFileSelector::GetFileName()
{
  // Return the name of the selected file

  TString FileName = m_Input->GetText();
  if (FileName != "") {
...
void MGUIEFileSelector::SetFileName(TString FileName)
{
...
void MGUIEFileSelector::SetFileType(TString Name, TString Suffix)
{
  // Set one filetype
