...
MGUIEMinMaxEntry::MGUIEMinMaxEntry(const TGWindow *Parent, TString Label, bool Emphasize,
...
TString MGUIEMinMaxEntry::MakeSmartString(double Number)
{
...
bool MGUIEMinMaxEntry::CheckForNumber(TString Number)
{
...
double MGUIEMinMaxEntry::ToNumber(TString Number) 
{
