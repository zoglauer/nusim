...
MResponseMatrixO1::MResponseMatrixO1(TString Name, vector<float> xAxis) 
...
void MResponseMatrixO1::SetAxisNames(TString x1Name)
{
...
TString MResponseMatrixO1::GetAxisName(unsigned int order) const
{
...
bool MResponseMatrixO1::Write(TString FileName, bool Stream)
{
