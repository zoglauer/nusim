...
MResponseMatrixO3::MResponseMatrixO3(TString Name, vector<float> x1Axis, 
...
void MResponseMatrixO3::SetAxisNames(TString x1Name, TString x2Name, 
                                     TString x3Name)
{
...
TString MResponseMatrixO3::GetAxisName(unsigned int order) const
{
...
bool MResponseMatrixO3::Write(TString FileName, bool Stream)
{
