...
class MResponseMatrixO2 : public MResponseMatrix
{
 ...
 public:
  ...
  MResponseMatrixO2(TString Name, vector<float> xDim, vector<float> yDim);
  ...
  void SetAxisNames(TString x1Name, TString x2Name);
  TString GetAxisName(unsigned int order = 2) const;
