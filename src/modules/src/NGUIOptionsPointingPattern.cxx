...
void NGUIOptionsPointingPattern::Create()
{
  ...
  m_DistanceBetweenPointings = new MGUIEEntry(this, "Distance between adjacent satellite pointings in arcmin (e.g. 7.3 arcmin):", false, dynamic_cast<NModuleSourceDistribution*>(m_Module)->GetDistanceBetweenPointings());
  ...
  m_Yaw = new MGUIEEntry(this, "A default yaw (rotation around z-axis) of the space craft in degree (use this to align the pointings):", false, dynamic_cast<NModuleSourceDistribution*>(m_Module)->GetYaw()/60.0);
	AddFrame(m_Yaw, NumberEntryLayout);
...
bool NGUIOptionsPointingPattern::OnApply()
{
  ...
  dynamic_cast<NModuleSourceDistribution*>(m_Module)->SetYaw(m_Yaw->GetAsDouble()*60);
