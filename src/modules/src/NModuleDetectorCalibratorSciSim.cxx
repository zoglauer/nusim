/*
 * NModuleDetectorCalibratorSciSim.cxx
 *
...
////////////////////////////////////////////////////////////////////////////////
//
// NModuleDetectorCalibratorSciSim
//
////////////////////////////////////////////////////////////////////////////////
...
#ifdef ___CINT___
ClassImp(NModuleDetectorCalibratorSciSim)
#endif
...
NModuleDetectorCalibratorSciSim::NModuleDetectorCalibratorSciSim(NSatellite& Satellite) : NModule(Satellite), NModuleInterfaceEvent()
{
  // Construct an instance of NModuleDetectorCalibratorSciSim

  // Set all module relevant information

  // Set the module name --- has to be unique
  m_Name = "SciSim thread calibrator";

  // Set the XML tag --- has to be unique --- no spaces allowed
  m_XmlTag = "XmlTagEnergyAndDepthCalibrationSciSim";
...
NModuleDetectorCalibratorSciSim::~NModuleDetectorCalibratorSciSim()
{
  // Delete this instance of NModuleDetectorCalibratorSciSim
}
...
bool NModuleDetectorCalibratorSciSim::Initialize()
{
...
bool NModuleDetectorCalibratorSciSim::AnalyzeEvent(NEvent& Event) 
{
  ...
  for (unsigned int i = 0; i < Event.GetNNinePixelHits(); ++i) {
    ...
    H.SetEnergy(Niner.GetNoisedEnergy());
...
void NModuleDetectorCalibratorSciSim::ShowOptionsGUI()
{
...
bool NModuleDetectorCalibratorSciSim::ReadXmlConfiguration(MXmlNode* Node)
{
...
MXmlNode* NModuleDetectorCalibratorSciSim::CreateXmlConfiguration() 
{
...
// NModuleDetectorCalibratorSciSim.cxx: the end...
////////////////////////////////////////////////////////////////////////////////
